...
<div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    ...
    <div class="text-sm lg:flex-grow">
      <a href="#responsive-header" class="block text-base mt-4 lg:inline-block lg:mt-0 font-bold text-purple-600 hover:text-white mr-4">
        collab.
      </a>
    </div>
...
<div class="flex-1 bg-gray-500 h-64"></div>
    ...
    <div>   
        ...
        <div class="flex">
<h1 class="text-md lg:text-xl text-green-600 mb-2 my-6 p-4">Coming Soon</h1>
<div class="min-w-32 bg-white min-h-48 p-3 mb-2 -mt-12  mx-96 font-medium">
    ...
    <div class="block rounded-t overflow-hidden  text-center ">
      ...
      <div class="pb-2 border-l border-r border-b rounded-b-lg text-center border-white bg-white">
        <span class="text-xs leading-normal">
            ...
            <h2 class="text-3xl lg:text-4xl font-bold text-teal-600 my-0 mb-2 lg:mb-6 mx-4">Campaign Name</h2>
       <div class="flex"> 
        ...
        <div class="flex">
            ...
            <h3 class="text-xl lg:text-2xl font-bold text-teal-600 mb-2 lg:mb-6">Description</h3>

            <p class="line-clamp-4">Figma is a browser-based UI and UX design application, with excellent
        design,prototyping,and code-generation tools. It's currently (arguably) the industry's leading interface design tool, with robust features which support teams
        working on every phase of the design process.</p>
             <h4 class="text-xl lg:text-2xl font-bold text-teal-600 mb-2 lg:mb-6">Registration</h4>
             <p>Hello! Please join the campaign, by register below.</p>
    </div>

    
    <div class="mb-6">
        <label for="name" class="font-bold mb-3 block text-teal-700">Name*</label>
        <input type="text" id="name" class="bg-gray-200 rounded-md border border-gray-200 p-3 focus:outline-none w-1/2" placeholder="  " required/>
    </div>

    <div class="mb-6">
        <label for="email" class="font-bold mb-3 block text-teal-700">Email*</label>
        <input type="email" id="email" class="bg-gray-200 rounded-md border border-gray-200 p-3 focus:outline-none w-1/2" placeholder="  " required/>
    </div>

    <div class="mb-6">
        <label for="question" class="font-bold mb-3 block text-teal-700">Why should you be a part of this campaign</label>
        <input type="text" id="question" class="bg-gray-200 rounded-md border border-gray-200 p-3 focus:outline-none w-1/2 h-36" placeholder="campaign pitch.." required/>
    </div>
  ...
  <form class="w-full">
    ...
    <div class="mx-2  grid grid-cols-5 gap-2 p-0">
        <button class="ring-0 ring-gray-600 bg-gray-400 
                       w-18 h-8 rounded-lg">
            IG Post
        </button>
        <button class="ring-0 ring-gray-600 bg-gray-400 
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
        ...
        <label for="name" class="font-bold my-3 block text-teal-700">Contact Number</label>

        </div>

        <div class="mb-6">
        <input type="text" id="name" class="bg-gray-200 rounded-md border border-gray-200 p-3 focus:outline-none w-1/2" placeholder="John Doe" required/>
    </div>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
        ...
        <label for="company_size" class="font-bold my-3 block text-teal-700">City</label>
     </div>

    <div class="mb-6">
        <select id="company_size" class="bg-gray-200 rounded-md border border-gray-200 p-3 focus:outline-none w-1/2" required>
